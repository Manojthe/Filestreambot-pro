...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = f"https://getseopost.com/how-to-start-a-successful-insurance-blog/?PIN={Var.URL}{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
